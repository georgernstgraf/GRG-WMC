...
| `docs/lehrplan/` | LEHRPLAN (3-layer source), METADATA, RIS, jahr1/jahr2-einheiten | created 2026-07-26 |
...
- Class folders + Unterlagen → `docs/lehrplan/jahrN-einheiten.md` (retrospective consolidation / forward planning)
- RIS (ris.bka.gv.at) + spengergasse.at → `docs/lehrplan/{LEHRPLAN,RIS,METADATA}.md` (legal sources, annual re-check in summer)
