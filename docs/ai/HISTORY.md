...
## 2026-07-26 (SUPERSEDED 2026-07-26, origin: README.md/AGENTS.md, reason: repo scope corrected to Erwachsenenbildung): Repo beschrieb sich als Tagesschul-Repo
- Root README.md: "WMC-Unterricht an der HTL Spengergasse (4. Klassen, Abteilung Informatik)"; AGENTS.md: "3aaif/3akif/3bkif/3caif - Student class sections (3rd year, different branches)".
